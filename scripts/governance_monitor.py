...
class GovernanceMonitor:
    ...
    def run_compliance_check(self) -> Dict[str, Any]:
        ...
        logger.info(f"Compliance check completed with score: {results['overall_score']}%")
    ...
    def _check_studies_compliance(self) -> Dict[str, Any]:
        ...
        existing_files = [f.name for f in master_studies_path.glob("*.md") if f.is_file()]
    ...
    def _generate_recommendations(self, results: Dict[str, Any]) -> List[str]:
        ...
        for category, data in results['categories'].items():
            ...
            if category == 'code' and score < 70:
                recommendations.append("Implement code structure according to technical specifications")
                ...
                recommendations.append("Implement security best practices from compliance studies")
                recommendations.append("Set up automated security scanning")

            elif category == 'studies' and score < 70:
                recommendations.append("Ensure all master study files are present and up-to-date")
    ...
    def _save_results(self, results: Dict[str, Any]):
        """حفظ نتائج الفحص"""
        results_file = self.logs_path / f"governance_check_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
    ...
    def generate_daily_report(self) -> Dict[str, Any]:
        ...
        # حفظ التقرير اليومي
        report_file = self.logs_path / f"daily_report_{datetime.now().strftime('%Y%m%d')}.json"
    ...
    def _get_project_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'overall_progress': sum([has_backend, has_frontend, has_tests, has_docs]) / 4 * 100
        }
